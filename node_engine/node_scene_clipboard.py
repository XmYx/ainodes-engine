...
class SceneClipboard():
    ...
    def serializeSelected(self, delete: bool=False) -> OrderedDict:
        ...
        :type delete: ``bool``
        :return: Serialized data of current selection in NodeEditor :class:`~node_engine.node_scene.Scene`
        """
        ...
        # remove all edges which are not connected to a node_engine in our list
        edges_to_remove = []
    ...
    def deserializeFromClipboard(self, data: dict, *args, **kwargs):
        ...
        :param data: ``dict`` data for deserialization to the :class:`node_engine.node_scene.Scene`.
        :type data: ``dict``
        """
