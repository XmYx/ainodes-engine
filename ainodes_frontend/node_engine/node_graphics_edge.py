...
class QDMGraphicsEdge(QGraphicsPathItem):
    ...
    def determineEdgePathClass(self):
        ...
        from ainodes_frontend.node_engine.node_edge import EDGE_TYPE_BEZIER, EDGE_TYPE_DIRECT, EDGE_TYPE_SQUARE
    ...
    def setColorFromSockets(self) -> bool:
        ...
        if hasattr(self.edge.start_socket, "grSocket"):
            if self.edge.start_socket.grSocket is not None:
