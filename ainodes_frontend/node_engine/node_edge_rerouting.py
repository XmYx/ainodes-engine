...
class EdgeRerouting:
    ...
    def getAffectedEdges(self) -> list:
        ...
        :return: List of all edges affected by the rerouting started from this `self.start_socket` :class:`~node_engine.node_socket.Socket`
        :rtype: ``list``
        """
    ...
    def setAffectedEdgesVisible(self, visibility: bool=True):
        ...
        :param visibility: ``True`` if all the affected :class:`~node_engine.node_edge.Edge` (s) should be shown or hidden
