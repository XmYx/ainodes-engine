...
from ainodes_backend.node_engine.node_graphics_edge_path import GraphicsEdgePathBezier, GraphicsEdgePathDirect, GraphicsEdgePathSquare
...
class QDMGraphicsEdge(QGraphicsPathItem):
    ...
    def __init__(self, edge:'Edge', parent:QWidget=None):
        """
        :param edge: reference to :class:`~node_engine.node_edge.Edge`
        ...
        :Instance attributes:
            ...
            - **edge** - reference to :class:`~node_engine.node_edge.Edge`
    ...
    def createEdgePathCalculator(self):
        """Create instance of :class:`~node_engine.node_graphics_edge_path.GraphicsEdgePathBase`"""
        self.pathCalculator = self.determineEdgePathClass()(self)
    ...
    def determineEdgePathClass(self):
        ...
        from ainodes_backend.node_engine.node_edge import EDGE_TYPE_BEZIER, EDGE_TYPE_DIRECT, EDGE_TYPE_SQUARE
    ...
    def calcPath(self) -> QPainterPath:
        ...
        is an instance of derived :class:`~node_engine.node_graphics_edge_path.GraphicsEdgePathBase` class
