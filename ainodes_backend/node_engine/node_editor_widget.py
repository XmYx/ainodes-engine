...
from ainodes_backend.node_engine.node_scene import Scene, InvalidFile
from ainodes_backend.node_engine.node_node import Node
from ainodes_backend.node_engine.node_edge import Edge, EDGE_TYPE_BEZIER
from ainodes_backend.node_engine.node_graphics_view import QDMGraphicsView
...
class NodeEditorWidget(QWidget):
    ...
    def initUI(self):
        """Set up this ``NodeEditorWidget`` with its layout,  :class:`~node_engine.node_scene.Scene` and
        :class:`~node_engine.node_graphics_view.QDMGraphicsView`"""
    ...
    def hasSelectedItems(self) -> bool:
        """Is there something selected in the :class:`node_engine.node_scene.Scene`?
