...
from ainodes_backend.node_engine.node_graphics_socket import QDMGraphicsSocket
...
class Socket(Serializable):
    ...
    def __init__(self, node: 'Node', name: str="Node", index: int=0, position: int=LEFT_TOP, socket_type: int=1, multi_edges: bool=True,
                 count_on_this_node_side: int=1, is_input: bool=False):
        """
        :param node: reference to the :class:`~node_engine.node_node.Node` containing this `Socket`
        ...
        :Instance Attributes:
            ...
            - **node** - reference to the :class:`~node_engine.node_node.Node` containing this `Socket`
            - **edges** - list of `Edges` connected to this `Socket`
            - **grSocket** - reference to the :class:`~node_engine.node_graphics_socket.QDMGraphicsSocket`
    ...
    def setSocketPosition(self):
        ...
        inside :class:`~node_engine.node_node.Node`."""
    ...
    def getSocketPosition(self):
        ...
        :return: Returns this `Socket` position according to the implementation stored in
            :class:`~node_engine.node_node.Node`
        :rtype: ``x, y`` position
        """
        if DEBUG: print("  GSP: ", self.index, self.position, "node_engine:", self.node)
    ...
    def hasAnyEdge(self) -> bool:
        """
        Returns ``True`` if any :class:`~node_engine.node_edge.Edge` is connected to this socket

        :return: ``True`` if any :class:`~node_engine.node_edge.Edge` is connected to this socket
        :rtype: ``bool``
        """
    ...
    def isConnected(self, edge: 'Edge') -> bool:
        """
        Returns ``True`` if :class:`~node_engine.node_edge.Edge` is connected to this `Socket`

        :param edge: :class:`~node_engine.node_edge.Edge` to check if it is connected to this `Socket`
    ...
    def addEdge(self, edge: 'Edge'):
        ...
        :param edge: :class:`~node_engine.node_edge.Edge` to connect to this `Socket`
        :type edge: :class:`~nodeeditor.node_edge.Edge`
        """
    ...
    def removeEdge(self, edge: 'Edge'):
        """
        Disconnect passed :class:`~node_engine.node_edge.Edge` from this `Socket`
        :param edge: :class:`~node_engine.node_edge.Edge` to disconnect
        :type edge: :class:`~nodeeditor.node_edge.Edge`
        """
