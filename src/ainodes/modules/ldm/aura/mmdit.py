...
class MMDiT(nn.Module):
    ...
    def apply_pos_embeds(self, x, h, w):
        ...
        cur_dim = self.h_max
        pos_encoding = modules.comfy_math.ops.cast_to_input(self.positional_encoding.reshape(1, cur_dim, cur_dim, -1), x)
    ...
    def forward(self, x, timestep, context, **kwargs):
        ...
        c = torch.cat([modules.comfy_math.ops.cast_to_input(self.register_tokens, c).repeat(c.size(0), 1, 1), c], dim=1)
