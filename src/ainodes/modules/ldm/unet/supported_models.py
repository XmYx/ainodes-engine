import torch
from modules.model_loading import model_base, diffusers_convert
from modules import utils

from modules.ldm.clip import sdxl_clip, sd1_clip
...
from modules.ldm.unet import supported_models_base
from modules import latent_formats
...
class SD20(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(modules.text_encoders.sd2_clip.SD2Tokenizer, modules.text_encoders.sd2_clip.SD2ClipModel)
...
class SD3(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        ...
        return supported_models_base.ClipTarget(modules.text_encoders.sd3_clip.SD3Tokenizer, modules.text_encoders.sd3_clip.sd3_clip(clip_l=clip_l, clip_g=clip_g, t5=t5, dtype_t5=dtype_t5))
...
class StableAudio(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(modules.text_encoders.sa_t5.SAT5Tokenizer, modules.text_encoders.sa_t5.SAT5Model)
...
class AuraFlow(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(modules.text_encoders.aura_t5.AuraT5Tokenizer, modules.text_encoders.aura_t5.AuraT5Model)
...
class HunyuanDiT(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(modules.text_encoders.hydit.HyditTokenizer, modules.text_encoders.hydit.HyditModel)
...
class Flux(supported_models_base.BASE):
    ...
    def clip_target(self, state_dict={}):
        return supported_models_base.ClipTarget(modules.text_encoders.flux.FluxTokenizer, modules.text_encoders.flux.FluxClipModel)
