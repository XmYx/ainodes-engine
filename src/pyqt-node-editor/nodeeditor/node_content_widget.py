...
from PyQt5.QtWidgets import QSpinBox, QDoubleSpinBox, QLineEdit, QComboBox, QMenu, QStyle
...
class CustomSpinBox(QtWidgets.QSpinBox):
    set_signal = QtCore.pyqtSignal(int)
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
...
class CustomCheckBox(QtWidgets.QCheckBox):
    set_signal = QtCore.pyqtSignal(bool)
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    # def contextMenuEvent(self, event):
    #     # propagate to parent
...
class CustomLineEdit(QtWidgets.QLineEdit):
    set_signal = QtCore.pyqtSignal(str)
...
class CustomDoubleSpinBox(QtWidgets.QDoubleSpinBox):
    set_signal = QtCore.pyqtSignal(float)
    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)
    # def contextMenuEvent(self, event):
    #     # propagate to parent
...
class QDMNodeContentWidget(QWidget, Serializable):
    eval_signal = QtCore.pyqtSignal()
    mark_dirty_signal = QtCore.pyqtSignal()
    ...
    def create_combo_box(self, label_text, items, accessible_name=None, spawn=None, object_name=None) -> QtWidgets.QComboBox:
